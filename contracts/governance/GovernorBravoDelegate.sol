...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    uint public constant MIN_PROPOSAL_THRESHOLD = 100; // 100 MoonNFT = 1% of MoonNFT

    /// @notice The maximum setable proposal threshold
    uint public constant MAX_PROPOSAL_THRESHOLD = 10000; // 10000 MoonNFT = 100 % of MoonNFT
    ...
    uint public constant quorumVotes = 300; // 300 = 3% of MoonNFT
